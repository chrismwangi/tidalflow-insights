          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4 pt-2">
              <a 
                ...
                className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-chart-1 transition-colors"
                aria-label="LinkedIn"
              >
            ...
            <ul className="space-y-3">
              {quickLinks.map((link) => (
                <li key={link.href}>
                  <Link 
                    to={link.href} 
                    className="text-white/70 hover:text-chart-1 transition-colors text-sm"
                  >
                    {link.label}
                  </Link>
                </li>
            ...
            <ul className="space-y-4">
              <li>
                <a 
                  ...
                  className="flex items-start gap-3 text-white/70 hover:text-chart-1 transition-colors text-sm"
                >
